...
from reviews.schemas import ReviewCreateSchema, ReviewBaseSchema, StatusSentiment
...
async def api_get_reviews_by_sentiment(
    ...
    return await get_reviews_from_db_by_sentiment(
        session=session,
        sentiment=sentiment
    )
